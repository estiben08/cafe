        ...
        <style>
            ...
            * {
            ...
            body {
                ...
                /*
                * ELIMINADO: background-size y background-position
                * body no tiene background-image → propiedades sin efecto.
                */
                min-height: 100vh;
            ...
            /* ════════════════════════════════════════
            VIDEO FONDO
            ELIMINADO: .video-fondo .contenido
            No existe ningún .contenido dentro de .video-fondo en el HTML.
            ════════════════════════════════════════ */
            .video-fondo {
                position: absolute;
                top: 0;
            ...
            ELIMINADO: .navbar-left / .navbar-center / .navbar-right
            Ningún elemento del HTML tiene esas clases.
            ELIMINADO: .navbar-toggler y .navbar-toggler-icon
            El proyecto usa .btn-hamburguesa propio; el toggler de Bootstrap
            no está en el HTML.
            ════════════════════════════════════════ */
            .header-principal {
                position: fixed;
            ...
            /* ════════════════════════════════════════
            DROPDOWN USUARIO
            ELIMINADO: #btn-usuario img
            #btn-usuario contiene <i class="fa-solid fa-user">.
            El JS inserta img en #menu-avatar, no en este botón.
            ════════════════════════════════════════ */
            #btn-usuario {
                color: #ffffff;
                display: flex;
            ...
            /* ── Botones carrito y usuario móvil ── */
            #btn-usuario-mobile,
            #btn-carrito-mobile {
                color: #ffffff;
                display: flex;
            ...
            /* ── Footer drawer con sesión activa ── */
            .drawer-footer-user {
            ...
            .drawer-user-action-btn:hover i {
            ...
            ELIMINADO: bloques de .hero-section,
            .hero-content, .btn-asesor, @keyframes,
            .partners-section y todo el carrusel —
            ninguno de esos elementos existe en el HTML.
            ════════════════════════════════════════ */
            @media (max-width: 1024px) {
                ...
                /* Ocultar barra desktop en móvil */
                .navbar-custom .container {
                    display: none;
                }
    ...
    <body>
        <div class="header-container">
            ...
            <header class="header-principal">
                ...
                <script type="module">
                        ...
                        (user) => {
                            ...
                            if (btnMobile) {
                                ...
                                if (!existingMobileMenu) {
                                    ...
                                    if (mNombre) {
                                        mNombre.id = 'nombre-usuario-m';
                                        mNombre.textContent = user.displayName || user.email;
                                    }
                                    if (mAvatar) {
                    ...
                    /* Cerrar sesión — desktop y drawer */
        ...
        </div><!-- /header-container — corregido: div abierto que faltaba cerrar -->
