...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Botón toggler desktop (oculto en móvil nuevo) */
        .navbar-toggler {
            border: none;
            padding: 8px;
            background-color: rgba(255, 255, 255, 0.1);
        ...
        .menu-usuario-dropdown {
            ...
            width: 230px;
            background: #1c0b09;
            border: 1px solid rgba(210, 170, 100, 0.15);
            border-radius: 14px;
            overflow: hidden;
            box-shadow: 0 20px 50px rgba(0,0,0,0.6),
                        inset 0 1px 0 rgba(210,170,100,0.08);
            opacity: 0;
        ...
        .menu-usuario-dropdown::before {
            ...
            background: #1c0b09;
            border-top: 1px solid rgba(210, 170, 100, 0.15);
            border-left: 1px solid rgba(210, 170, 100, 0.15);
        ...
        .menu-usuario-avatar {
            ...
            border-radius: 50%;
            background: linear-gradient(135deg, #8B3A10, #c4762a);
            border: 1.5px solid rgba(210, 170, 100, 0.3);
            display: flex; align-items: center; justify-content: center;
            font-size: 15px; color: #f0e8d2;
        ...
        .menu-usuario-item:hover {
            ...
            color: #f0e8d2; padding-left: 20px;
        }
        .menu-usuario-logout { color: rgba(220, 100, 80, 0.65); }
        .menu-usuario-logout:hover {
            background: rgba(200, 60, 40, 0.08);
            color: #e07a5f; padding-left: 20px;
        }
        .menu-usuario-tag {
            font-size: 10.5px; color: rgba(210, 170, 100, 0.5);
        ...
        .btn-asesor {
            ...
            font-size: 12.83px; font-weight: 500;
            line-height: 22.96px; letter-spacing: 0.14px;
        ...
        .partners-carousel {
            width: 792px; max-width: 100%; height: 95px;
        ...
        .partners-text {
            color: #ffffff; font-size: 21.67px;
            font-weight: 700; min-width: 200px; text-align: left;
        }
        .arriba {
        ...
        .carousel-controls {
            ...
            margin-top: 10px; margin-left: 20px; gap: 40px;
        }
        ...
        /* ════════════════════════════════════════
           RESPONSIVE MÓVIL — NUEVO SISTEMA (≤ 768px)
           Header: [☰]  [LOGO]  [👤]
           Drawer lateral con fondo #1c0b09
        ════════════════════════════════════════ */
        @media (max-width: 1024px) {
            ...
            .arriba             { font-size: 10px; top: 7px; left: 10px; width: auto; }
            .carousel-controls  {
                margin-left: 0;
                margin-top: 18px;
                gap: 6px;
            ...
            .carousel-btn       { width: 26px; height: 26px; flex-shrink: 0; }
            .izquierdo, .derecho { font-size: 13px; width: auto; }
            .logo-image         { height: 16px; }
            .logo-container     { gap: 12px; }
        }

        /* Ocultar barra móvil en desktop */
        ...
        #btn-usuario-mobile:hover,
        #btn-carrito-mobile:hover {
            transform: scale(1.1);
            background: rgba(255,255,255,0.15);
        }

        /* ── Drawer footer con sesión ── */
        .drawer-footer-user {
        ...
        .drawer-user-action-btn {
            ...
            border: 1px solid rgba(210,170,100,0.12);
            border-radius: 10px;
        ...
        .drawer-user-action-btn i {
            font-size: 17px;
            color: rgba(210,170,100,0.7);
        }
        .drawer-user-action-btn:hover {
        ...
        .drawer {
            ...
            border-right: 1px solid rgba(210,170,100,0.12);
        ...
        .drawer-nav a:hover {
            color: #f0e8d2;
            background: rgba(210,170,100,0.07);
            border-left-color: rgba(210,170,100,0.45);
            padding-left: 26px;
        }
        ...
        .drawer-footer {
            ...
            border-top: 1px solid rgba(210,170,100,0.1);
        }
        .btn-iniciar-sesion {
            display: flex; align-items: center;
            justify-content: center; gap: 8px;
            ...
            cursor: pointer; text-decoration: none;
            transition: all 0.25s ease;
            box-shadow: 0 4px 14px rgba(139,58,16,0.4);
        }
        .btn-iniciar-sesion:hover {
            transform: translateY(-1px);
            box-shadow: 0 6px 20px rgba(139,58,16,0.55);
            filter: brightness(1.08);
            color: #f0e8d2;
        }
        .btn-iniciar-sesion:active { transform: translateY(0); }
    ...
    <div class="header-container">
        ...
        <header class="header-principal">
            ...
            <script type="module">
                ...
                // Móvil: dropdown sobre btn-usuario-mobile
                const btnMobile       = document.getElementById('btn-usuario-mobile');

                // Clonar el menu-usuario-dropdown para móvil (comparte el mismo DOM)
                // El dropdown ya existe en .social-icons desktop; en móvil lo posicionamos via JS
                ...
                observarUsuario(
                    (user) => {
                        ...
                        if (user.photoURL) {
                            avatarEl.innerHTML = `<img src="${user.photoURL}" alt="foto">`;
                        }
                        ...
                        /* ── Drawer: mostrar estado con sesión ── */
                        drawerGuest.style.display = 'none';
                        drawerUser.style.display  = 'block';
                        drawerNombreEl.textContent = user.displayName || user.email;
                        if (user.photoURL) {
                            drawerAvatarEl.innerHTML = `<img src="${user.photoURL}" alt="foto">`;
                        }

                        /* ── Móvil: ícono usuario abre dropdown ── */
                        if (btnMobile) {
                            btnMobile.removeAttribute('href');
                            btnMobile.style.cursor = 'pointer';
                            // Mover el dropdown para que quede relativo al btn móvil
                            btnMobile.style.position = 'relative';
                            // Clonar el dropdown al lado del botón móvil
                            ...
                            if (!existingMobileMenu) {
                                ...
                                if (mAvatar) {
                                    mAvatar.id = 'menu-avatar-m';
                                    if (user.photoURL) mAvatar.innerHTML = `<img src="${user.photoURL}" alt="foto">`;
                                }
                                // Botones del clon
                ...
                document.addEventListener('click', (e) => {
                    ...
                    const mm = document.getElementById('menu-usuario-mobile');
                    const bm = document.getElementById('btn-usuario-mobile');
                    if (mm && !bm?.contains(e.target) && !mm?.contains(e.target)) {
        ...
        <div class="drawer" id="drawer">
            ...
            <!-- Footer CON sesión (oculto por defecto) -->
            <div class="drawer-footer drawer-footer-user" id="drawer-footer-user" style="display:none;">
                ...
                <div class="drawer-user-actions">
                    ...
                    <a href="#" class="drawer-user-action-btn">
                        <i class="fa-solid fa-cart-shopping"></i>
                        Carrito
                    </a>
                </div>
